/*
    ...
    Expected Function List tree:
        CodeSample2_Macroscript.mcr
        +-- Wk3DTexturer_Macroscript
        |   +-- myFunction02
        |   \-- myFunction03
        \-- MySecond_Macroscript
            +-- myFunction02
            \-- myFunction03
...
macroScript MySecond_Macroscript category:"WerwacKScripts" internalCategory:"WerwacKScripts" tooltip: "Wk3DTexturer" buttonText:"Wk3DTexturer"
(
	-- !!! Do not change this line directly in the template !!! It may be automatically replaced by the installer
	local lScriptRootDir = getdir #userScripts + "\\"
